...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    fortifyGreenAuthUserSubject.add(
      FortifyGreenAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<FortifyGreenAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  FortifyGreenAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = FortifyGreenAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    fortifyGreenAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
FortifyGreenAuthUser? currentUser;
